...
def sk_make_rgb_image(data, output, bluetxt, greentxt, redtxt, indices=(0, 1, 2), \
                   vmin_r=None, vmax_r=None, pmin_r=0.25, pmax_r=99.75, \
                   stretch_r='linear', vmid_r=None, exponent_r=2, \
                   vmin_g=None, vmax_g=None, pmin_g=0.25, pmax_g=99.75, \
                   stretch_g='linear', vmid_g=None, exponent_g=2, \
    ...
    d.text((50,60), bluetxt, font=fnt, fill=(0,0,255,255))
    d.text((350,60), greentxt, font=fnt, fill=(0,255,0,255))
    d.text((650,60), redtxt, font=fnt, fill=(255,0,0,255))
